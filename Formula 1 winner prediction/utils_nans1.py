...
def are_assumptions_satisfied(model, features, labels, p_value_thresh=0.05):
    ...
    n_dist_type, p_value1 = normality_of_errors_assumption(model, x_with_const, labels, p_value_thresh, plot=False)
    ...
    print('Linearnost je ')
    print(e_dist_type,is_linearity_found,dw_value,p_value1)
    if is_linearity_found and autocorrelation is None and n_dist_type == 'normal' and e_dist_type == 'equal':
        return True
    else:
        return False
